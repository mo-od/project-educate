            ...
            <div class="table-responsive">
              ...
              ?>  
                  <tr>
                    ...
                    <td><b><input class="form-control-sm col-10"  type="text" value="<?php echo $datauser["email"]; ?>" readonly></b></td>
                    <td><b><input class="form-control-sm col-10"  type="text" value="<?php echo $datauser["link"]; ?>"readonly ></b></td>
                    <td><b><?php echo $datauser["date"]; ?></b></td>
                    <td><b><font size="3"color="#E74C3C"><?php echo number_format($datauser['point'],2); ?></font></b></td>
                    <td>
                      <a class="btn btn-success btn-sm" href="edituser.php?u_id=<?php echo $datauser['u_id']; ?>" ><i class="fas fa-pencil-alt fa-fw"></i><b>Edit &nbsp;</b></a>
                    </td>
                  </tr>
                  <?php  
                     $num++;} 
