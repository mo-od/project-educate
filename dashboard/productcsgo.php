    ...
    <div class="content-wrapper">
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">CS:GO Product</li>
        </ol>
        <!-- Example Tables Card -->
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-striped" width="100%" id="dataTable" cellspacing="0">
                ...
                <tbody>
                <?php  
              $query = "SELECT * FROM product WHERE p_type = 2 ORDER BY p_id ASC";  
              ...
              ?>  
                  <tr>
                    ...
                    <td align="center" >
                    <form role="form" action="productcsgo.php?p_id=<?=$row['p_id'];?>" method="POST" id="update" name="updateunit" >
                    ...
                    <td align="center" >
                    <form role="form" action="productcsgo.php?p_id=<?=$row['p_id'];?>" method="POST" id="updateprice" name="updateprice" >
