    ...
    <div class="content-wrapper">
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">PUBG Product</li>
        </ol>
        <!-- Example Tables Card -->
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-striped" width="100%" id="dataTable" cellspacing="0">
                ...
                <tbody>
                <?php  
              $query = "SELECT * FROM product WHERE p_type = 3 ORDER BY p_id ASC";  
              ...
              ?>  
                  <tr>
                    ...
                    <td align="center" >
                    <form role="form" action="productpubg.php?p_id=<?=$row['p_id'];?>" method="POST" id="update" name="updateunit" >
                    ...
                    <td align="center" >
                    <form role="form" action="productpubg.php?p_id=<?=$row['p_id'];?>" method="POST" id="updateprice" name="updateprice" >
                    ...
                    <form role="form" method="POST">
                      <button class="btn btn-danger btn-sm" type="submit" name="delproduct" value="<?php echo $row['p_id']; ?>" >&nbsp;<i class="fas fa-trash fa-fw"></i><b>Delete&nbsp;</b> </button>
                    </form>
                    </td>
                  </tr>
                  <?php  
      ...
      if(isset($_POST['submitupdate'])){ 
        ...
        swal({
          ...
          icon: "success",
              ...
              echo '<meta http-equiv="refresh" content="1; url=productpubg.php" />';
        mysqli_close($conn);
        exit;
      }  
      ?>
    <?php //Up Date Unit Product
      ...
      ?>
       <?php //Delete
        ...
        $del_product = mysqli_query($conn,$delproduct)or die("Delete Productpubg Failed". mysqli_error());
        mysqli_close($conn);
        echo '<script language="JavaScript">
        swal({
          title: "Success!",
