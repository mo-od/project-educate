...
<!-- Search End -->
    ...
    <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
      <div class="carousel-inner" role="listbox">
        <div class="carousel-item active">
          <img class="d-block img-fluid" src="img/storedota.png"  alt="dota2" > 
        </div>
        </div>
  </div>
  ...
  include_once("config/connectdb.php");//ใส่ ../ คือการเลือกไฟล์จาก โฟลเดอร์ข้างนอก
    ...
    (p_name LIKE '%".$_GET["txtKeyword"]."%' or p_rarity LIKE '%".$_GET["txtKeyword"]."%' or p_description LIKE '%".$_GET["txtKeyword"]."%' or name_pro  LIKE '%".$_GET["txtKeyword"]."%' )AND typeproduct.type  = 1";
