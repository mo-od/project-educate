...
--
-- Table structure for table `orders_run`
--
...
--
-- Dumping data for table `orders_run`
--
...
--
-- Table structure for table `rateprice`
--
...
--
-- Dumping data for table `rateprice`
--
...
--
ALTER TABLE `rateprice`
  MODIFY `rp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
