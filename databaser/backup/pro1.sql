...
--
-- Host: 127.0.0.1
-- Generation Time: 12 มี.ค. 2020 เมื่อ 02:51 AM
...
INSERT INTO `sell` (`sell_id`, `sell_steam`, `sell_bank`, `sell_bankacc`, `sell_date`, `sell_time`, `sell_remark`, `sell_status`) VALUES
(1, 'Frank', 'พร้อมเพย์', '0821338090', '2020-03-11', '20:52:00', 'Test', '1');
...
--
ALTER TABLE `sell`
  MODIFY `sell_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
