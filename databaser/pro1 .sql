...
--
-- Host: 127.0.0.1
-- Generation Time: 31 มี.ค. 2020 เมื่อ 07:04 PM
...
(357, '76', 3, '1', 20, 400, 8000, '2020-03-23 22:58:51'),
(358, '76', 3, '2', 1, 500, 500, '2020-03-23 22:58:51'),
(359, '76', 3, '3', 1, 450, 450, '2020-03-23 22:58:51'),
(360, '77', 3, '2', 15, 500, 7500, '2020-03-23 23:00:44'),
(361, '77', 3, '3', 1, 450, 450, '2020-03-23 23:00:44'),
(362, '77', 3, '1', 1, 400, 400, '2020-03-23 23:00:44'),
(363, '77', 3, '4', 1, 150, 150, '2020-03-23 23:00:44'),
(364, '78', 3, '1', 20, 400, 8000, '2020-03-23 23:01:59'),
(365, '78', 3, '2', 20, 500, 10000, '2020-03-23 23:01:59'),
(366, '79', 3, '1', 21, 400, 8400, '2020-03-23 23:03:20'),
(367, '79', 3, '2', 20, 500, 10000, '2020-03-23 23:03:20');
...
(76, 3, '2020-03-23 22:58:51', '1'),
(77, 3, '2020-03-23 23:00:44', '1'),
(78, 3, '2020-03-23 23:01:59', '1'),
(79, 3, '2020-03-23 23:03:20', '1');
...
(1, 'Righteous Thunderbolt', 'zeus', 'p1.jpg', 400, '1', 'Imortal', '20'),
(2, 'The Magus Cypher', 'Rubick\'s', 'p2.jpg', 500, '1', 'arcana', '20'),
(3, 'Sylvan Cascade', 'Windranger ', 'p3.jpg', 450, '1', 'Imortal', '14'),
(4, 'Gravelmaw', 'Earthshaker ', 'gravelmaw.png', 150, '1', 'Immortal', '18'),
...
(1, 'Gimlek Decanter', 26.4, 'Ogre Magi   ', '2'),
(2, 'Exalted Frost Avalanche', 599, 'Crystal Maiden  ', '1'),
(6, 'Inscribed Offhand Basher of Mage Skulls', 23.2, 'Antimage', '1'),
(19, 'Honey Heist Baby Roshan', 11090, 'Courier', '1'),
(20, 'Dragonclaw Hook', 16380, 'pudge', '1'),
(21, 'Genuine Golden Floodmask', 7500, 'tidehunter', '1'),
(22, 'Inscribed Crimson Edge of the Lost Order', 9560, 'juggernaut', '1'),
(23, 'Genuine Axe of Phractos', 24550, 'axe', '1'),
(24, 'Genuine Lava Baby Roshan', 15483, 'Courier', '1'),
(25, 'Platinum Baby Roshan', 46800, 'Courier', '1');
...
(12, 3, 100, '‎Krungthai', '2020-02-26', '12:18:00', 'topup/87365337_2382696312022003_248008084734083072_n.jpg', '', '1');
...
(3, 'root', '25d55ad283aa400af464c76d713c07ad', 'Frank', 'lisa@yg.com', 'https://steamcommunity.com/tradeoffer/new/?partner=441522523&token=TM91C-IV&fbclid=IwAR1USrt6Ga2XaMLmevepV9jIBjlQXjrg5lOYgvSFLXhE96pupDHfqmVbYIw', '1', '2019-12-04 00:00:00', '843988'),
...
--
ALTER TABLE `orders`
  MODIFY `orders_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=368;

--
-- AUTO_INCREMENT for table `orders_run`
--
ALTER TABLE `orders_run`
  MODIFY `ordersid_run` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=80;
...
--
ALTER TABLE `rateprice`
  MODIFY `rp_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
